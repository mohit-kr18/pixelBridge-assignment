...
//------------------------------- this function is used for common button---------------
...
//-------------------------------- this function is used for common section used in Earn page ----------
...
earn.forEach((section) => {
  ...
  section.items2.length !==0 ? htmlContent2 += `<div class="blank_div" ></div>`: null
